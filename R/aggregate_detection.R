...
#' @param score_threshold Number of channel combinations in which a cells should at least be labeled as an aggregate (aggregate_score) to regard it as an aggregate. The higher the number, the less likely false positives will occur, but the more likely aggregates could be missed. Default: 3.
...
#' seu <- detect_aggregates(seu, problem_channels[[3]], score_threshold = 2)
